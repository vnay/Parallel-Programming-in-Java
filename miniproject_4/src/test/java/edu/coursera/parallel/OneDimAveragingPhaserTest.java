...
public class OneDimAveragingPhaserTest extends TestCase {
    ...
    private double parTestHelper(final int N, final int ntasks) {
        ...
        for (int r = 0; r < 3; r++) {
            ...
            System.out.println("barrier time = " + barrierTotalTime);
            ...
            System.out.println("fuzzy time = " + fuzzyTotalTime);
            System.out.println("Speed = " + (double)barrierTotalTime/fuzzyTotalTime);
    ...
    public void testFuzzyBarrier() {
        ...
        //final double speedup = parTestHelper(100 * 1024, getNCores() * 1);
        final double speedup = parTestHelper(2 * 100 * 1024, (int)(getNCores() * 0.5));
